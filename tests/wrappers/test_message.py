...
def test_message_equality() -> None:
    ...
    message_one = Message("text", "channel", "user", "timestamp", "team", "bot_id")
    message_two = Message("text", "channel", "user", "timestamp", "team", "bot_id")
...
def test_message_equality_fails() -> None:
    ...
    message_one = Message("text", "channel", "user", "timestamp", "team", "bot_id")
    message_two = Message("text2", "channel", "user", "timestamp", "team", "bot_id")
...
def test_response_repr() -> None:
    ...
    message = Message("text", "channel", "user", "timestamp", "team", "bot_id")
